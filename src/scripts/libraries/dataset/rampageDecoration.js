...
// Load Dataset
import RampageDecorations from '@/scripts/datasets/rampageDecorations.json'
...
//     ]
// ]
const dataset = RampageDecorations.map((decorationItem) => {
    return {
        id: decorationItem[0],
...
class RampageDecorationDataset {
...
export default new RampageDecorationDataset(dataset)
